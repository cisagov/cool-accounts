...
| provisionthirdpartybucketreadroles_role_name | The name to assign the IAM role (as well as the corresponding policy) that allows sufficient permissions to read objects in the third-party file storage S3 bucket in the Images account. | string | `ThirdPartyBucketRead` | no |
