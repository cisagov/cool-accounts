# ------------------------------------------------------------------------------
# Create the IAM policy that allows sufficient access to Domain Manager-related
# S3 and DynamoDB resources to use them for a Terraform backend.  Note that
# this policy does NOT allow access to non-Domain Manager S3 and DynamoDB
# resources.
# ------------------------------------------------------------------------------
...
# backend for Domain Manager projects.
...
# The IAM policy for Domain Manager Terraform access
