...
variable "account_provisioners_group_membership_name" {
  description = "The name to associate with the membership of the IAM group allowed to assume the role with sufficient permissions to provision the Pettifogger0 account."
  default     = "pettifogger0_account_provisioners_membership"
}

variable "account_provisioners_group_name" {
  description = "The name to associate with the IAM group allowed to assume the role with sufficient permissions to provision the Pettifogger0 account."
  default     = "pettifogger0_account_provisioners"
}

variable "assume_provisionaccount_policy_description" {
  description = "The description to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the Pettifogger0 account."
  default     = "Allow assumption of the ProvisionAccount role in the Pettifogger0 account."
}

variable "assume_provisionaccount_policy_name" {
  description = "The name to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the Pettifogger0 account."
  default     = "Pettifogger0-AssumeProvisionAccount"
}
