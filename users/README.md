...
| assume_audit_provisionaccount_policy_description | The description to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the Audit account. | string | `Allow assumption of the ProvisionAccount role in the Audit account.` | no |
| assume_audit_provisionaccount_policy_name | The name to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the Audit account. | string | `Audit-AssumeProvisionAccount` | no |
| assume_dns_provisionaccount_policy_description | The description to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the DNS account. | string | `Allow assumption of the ProvisionAccount role in the DNS account.` | no |
| assume_dns_provisionaccount_policy_name | The name to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the DNS account. | string | `DNS-AssumeProvisionAccount` | no |
| assume_images_provisionaccount_policy_description | The description to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the Images account. | string | `Allow assumption of the ProvisionAccount role in the Images account.` | no |
| assume_images_provisionaccount_policy_name | The name to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the Images account. | string | `Images-AssumeProvisionAccount` | no |
| assume_logarchive_provisionaccount_policy_description | The description to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the Log Archive account. | string | `Allow assumption of the ProvisionAccount role in the Log Archive account.` | no |
| assume_logarchive_provisionaccount_policy_name | The name to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the Log Archive account. | string | `LogArchive-AssumeProvisionAccount` | no |
...
| assume_master_provisionaccount_policy_description | The description to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the Master account. | string | `Allow assumption of the ProvisionAccount role in the Master account.` | no |
| assume_master_provisionaccount_policy_name | The name to associate with the IAM policy that allows assumption of the role with sufficient permissions to provision all AWS resources in the Master account. | string | `Master-AssumeProvisionAccount` | no |
...
| audit_account_provisioners_group_name | The name to associate with the IAM group allowed to assume the role with sufficient permissions to provision the Audit account. | string | `audit_account_provisioners` | no |
...
| dns_account_provisioners_group_name | The name to associate with the IAM group allowed to assume the role with sufficient permissions to provision the DNS account. | string | `dns_account_provisioners` | no |
...
| images_account_provisioners_group_name | The name to associate with the IAM group allowed to assume the role with sufficient permissions to provision the Images account. | string | `images_account_provisioners` | no |
...
| logarchive_account_provisioners_group_name | The name to associate with the IAM group allowed to assume the role with sufficient permissions to provision the Log Archive account. | string | `logarchive_account_provisioners` | no |
...
| master_account_provisioners_group_name | The name to associate with the IAM group allowed to assume the role with sufficient permissions to provision the Master account. | string | `master_account_provisioners` | no |
